...
public class clustering extends javax.swing.JFrame {
    ...
    public clustering() {
        initComponents();
          try {
            ...
            st3.executeUpdate("truncate table clustering");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         try {
            ...
            int e;
            String str = null;
            ResultSet rs = st.executeQuery("select n,v,l,d,i,e,defects from datset  ");
            while (rs.next()) {
               ...
               String que = "INSERT INTO `gradeprediction`.`clustering` (`n`, `v`, `l`, `d`, `i`,`e`) VALUES ('" + a + "', '" + b + "', '" + c + "', '" + f + "', '" + g + "', '" + str + "')";
...
//            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         try {
            ResultSet rs1 = st2.executeQuery("Show columns FROM `clustering`");
            while (rs1.next()) {
                String s = rs1.getString(1);
                jTextArea1.append(s + "\t");
            }
            jTextArea1.append("\n*******************************************************************************\n");
            ResultSet rs = st1.executeQuery("select * from clustering");
            while (rs.next()) {
